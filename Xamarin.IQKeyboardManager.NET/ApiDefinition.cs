...
namespace Xamarin.IQKeyboardManager.NET
{
    ...
    [Category]
    [BaseType(typeof(UIView))]
    partial interface UIView_Extensions
    {
        ...
        void SetKeyboardDistanceFromTextField(nfloat distance);
